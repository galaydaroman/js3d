...
// model paths
const BANK_PATH         = "/wp-content/2.0Release/rts/models/bank/bank.dae";
const BARRACKS_PATH     = "/wp-content/2.0Release/rts/models/barracks/barracks.dae";
const CUBE_PATH         = "/wp-content/2.0Release/rts/models/cube/cube.dae";
const FARM_PATH         = "/wp-content/2.0Release/rts/models/farm/farm.dae";
const FIREHALL_PATH     = "/wp-content/2.0Release/rts/models/firehall/firehall.dae";
const HOUSE_PATH        = "/wp-content/2.0Release/rts/models/house/house.dae";
const LUMBER_YARD_PATH  = "/wp-content/2.0Release/rts/models/lumber_yard/lumber_yard.dae";
const PERSON_PATH       = "/wp-content/2.0Release/rts/models/person/person.dae";
const PLANE_PATH        = "/wp-content/2.0Release/rts/models/plane/plane.dae";
const SPHERE_PATH       = "/wp-content/2.0Release/rts/models/skysphere.dae"
  ...
  if(holdingBuilding == null){
    for( var i = 0; i < usersBuildings.length; i++) {
      ...
      if(pointInPolygon([ux,uy]))
      {
        ...
        usersBuildings[i].TEST = 1;
      }
      else
      {
        usersBuildings[i].setEffect(null);
        usersBuildings[i].TEST = 0;
      }
    }
  }
...
function onKeyDown(event) {
  ...
  switch(event.keyCode) {  
    ...
    case KEY_F:     keysDown.KEY_F = true;fire();break;
...
function fire(){
    for(var i=0; i < usersBuildings.length; i++){
    if(usersBuildings[i].TEST){
    
     var psys = new c3dl.ParticleSystem();
	psys.setMinVelocity([-4,0,4]);
	psys.setMaxVelocity([4,18, -4]);
  
	psys.setMinLifetime(2.0);
	psys.setMaxLifetime(3.5);
  
	psys.setMinColor([0.9,0.4,0.45,0]);
	psys.setMaxColor([0.55,0.5,0,5]);
  ...
  psys.setMaxSize(3.0);
	...
	psys.setTexture("/wp-content/2.0Release/rts/textures/flare.gif");
	psys.setAcceleration([0,0,0]);
	psys.setEmitRate(60);
	psys.init(150);
  var bpos = usersBuildings[i].getPosition();
  psys.setPosition([bpos[0],bpos[1]+ 2, bpos[2]]);
...
function onKeyUp(event) {
  ...
  switch(event.keyCode) {
    ...
    case KEY_F:     keysDown.KEY_F = false;break;
    default:break;
  }
}
...
function showCancelBuildingImg(show) {
  ...
  if(show) {
    img.src = "/wp-content/2.0Release/rts/images/cancel_building.png";
  }
  else{
    img.src = "/wp-content/2.0Release/rts/images/blank.png";
  }
}
...
function updateDOM() {
  ...
  if(usersMoney < 500) {
    house.src = "/wp-content/2.0Release/rts/images/house/house_icon_gray.png";
    firehall.src = "/wp-content/2.0Release/rts/images/firehall/firehall_icon_gray.png";
    lumberYard.src = "/wp-content/2.0Release/rts/images/lumber_yard/lumber_yard_icon_gray.png";
    bank.src = "/wp-content/2.0Release/rts/images/bank/bank_icon_gray.png";
  }
  else {
    house.src = "/wp-content/2.0Release/rts/images/house/house_icon_up.png";
    firehall.src = "/wp-content/2.0Release/rts/images/firehall/firehall_icon_up.png";
    lumberYard.src = "/wp-content/2.0Release/rts/images/lumber_yard/lumber_yard_icon_up.png";
    bank.src = "/wp-content/2.0Release/rts/images/bank/bank_icon_up.png";
  }
...
function update(deltaTime) {
  ...
  var quat = c3dl.axisAngleToQuat([0, 0, -1], deltaTime / 3000);
